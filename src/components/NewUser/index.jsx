    ...
    <div className="glass-card">
      ...
      <form action="submit">
        ...
        <div className="relative my-4">
          ...
          <label htmlFor="" className="moving-label">Your Password</label>
          <FontAwesomeIcon icon={faLock} size="1x" className="absolute top-4 right-4"/>
        </div>
        <div className="relative my-4">
          <input type="password" className="custom-input peer" placeholder=""/>
          <label htmlFor="" className="moving-label">Confirm Password</label>
          <FontAwesomeIcon icon={faLock} size="1x" className="absolute top-4 right-4"/>
        </div>
        <button type="submit" className="primary-button">Sign Up</button>
        <span>Already an User? <Link href="/" className="text-white/50 font-bold underline">Sign In</Link> </span>
      </form>
    </div>
  );
};
