  ...
  return (
    <header className="w-full fixed z-10 bg-black">
      <nav className="flex w-full py-2 md:py-3 px-4 md:px-20 items-center justify-between">
        ...
        <Button title='oi' containerStyle='hidden md:block bg-transparent border border-white text-white hover:bg-white hover:text-cyan-600 rounded-full min-w-[130px]'/>
        <button className="block md:hidden text-white gap-6" onClick={() => setOpen(prev => !prev)}>
